    ...
    return (
      <Form {...form}>
        ...
        >
          ...
          {/* Submit Button */}
          <Button className="text-[var(--rv-white)]" type="submit" disabled={loading}>
      ...
      {isQuizCompleted ? (
        <div className="flex flex-col items-center text-center">
          ...
          <button
            ...
            className="mt-6 bg-gray-800 text-[var(--rv-white)] px-4 py-2 rounded-lg hover:bg-gray-900"
          >
            Back Home
          </button>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <Button
            ...
            className="text-black border px-4 py-2 rounded-lg hover:bg-[var(--rv-bg-primary)] hover:text-[var(--rv-white)] w-1/3 "
          >
            Next
          </Button>
        </div>
