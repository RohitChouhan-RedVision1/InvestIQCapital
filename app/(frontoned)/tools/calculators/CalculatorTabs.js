      ...
      <div className="flex justify-center mb-14">
        <div className="inline-flex border border-[var(--rv-primary)] rounded-full shadow-inner">
          <Link
            ...
            className={`px-5 md:px-20 py-2 text-lg font-medium border border-[var(--rv-primary)] hover:bg-[var(--rv-primary)] hover:text-[var(--rv-white)] rounded-l-full transition-all duration-300 ${
              isMonthlySip
          ...
          <Link
            ...
            className={`px-5 md:px-20 py-2 text-lg hover:bg-[var(--rv-primary)] hover:text-[var(--rv-white)] font-medium border border-[var(--rv-primary)] rounded-r-full transition-all duration-300 ${
              !isMonthlySip
                ? "bg-[var(--rv-primary)] text-[var(--rv-white)]"
                : "bg-[var(--rv-secondary)] text-[var(--rv-primary)]"
            }`}
            ...
            {calculators.map((item, index) => (
              <Link href={item?.route} key={index}>
                <div className="px-2 bg-[var(--rv-primary)] h-14 flex gap-4 rounded items-center text-center shadow-md group">
                  ...
                  <div>
                    <p className="font-bold text-[var(--rv-white)] text-md text-center group-hover:text-[#F3F3E0] mb-0">
                      {item?.title}
                    </p>
                  </div>
                </div>
            ...
            {performance.map((item, index) => (
              <Link href={item.link} key={index}>
                <div className="px-2 bg-[var(--rv-primary)] h-14 flex gap-4 items-center rounded-md shadow-md group">
                  ...
                  <div>
                    <p className="font-bold text-[var(--rv-white)] text-md group-hover:text-[#F3F3E0] mb-0">
                      {item?.title}
                    </p>
                  </div>
                </div>
