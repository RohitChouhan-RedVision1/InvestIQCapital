      ...
      <div className="max-w-screen-xl main_section mx-auto " ref={mainCounterRef}>
        <div className="  rounded-2xl">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 ">
            <motion.div className="col-span-1 shadow-lg rounded-2xl bg-[var(--rv-primary)] px-10 py-4 flex flex-col justify-between"
                ...
                <div className="flex justify-center space-x-4 mb-8">
                  <button
                    ...
                    className={`py-4 px-10 md:px-20 font-bold ${
                      isMonthlySip
                        ? "rounded-lg bg-[var(--rv-bg-secondary)] text-[var(--rv-white)]"
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="">
                          ...
                          <input
                            ...
                            className="ml-2 px-2 font-bold text-lg text-[var(--rv-white)] w-20 border-none"
                          />
                        </div>
                      </div>
                      <Input
                      ...
                      <div className="flex justify-between">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="ml-2 px-2 font-bold text-lg text-[var(--rv-white)] w-16  border-none"
                          />
                        </div>
                      </div>
                      <Input
                  ...
                  <div className="items-center mt-5">
                    <div className="flex justify-between">
                     ...
                     <div><input
                        ...
                        className="ml-2 px-2 font-bold text-lg text-[var(--rv-white)] w-10  border-none"
                      />
                        <span className="font-semibold text-[var(--rv-white)]">
                            YRS
                          </span></div>
                ...
                {isSubmitted ? (
                  ...
                  >
                    <DialogTrigger asChild>
                      <Button className=" bg-[var(--rv-secondary)] text-[var(--rv-white)]">Invest Now</Button>
                    </DialogTrigger>
            ...
            <div className="col-span-1  flex flex-col gap-4">
              <motion.div className=" bg-[var(--rv-primary)] rounded-2xl" id="graphId"
              ...
              <motion.div className="bg-[var(--rv-primary)] rounded-2xl" initial={{ y: 100, opacity: 0 }}
               animate={isInView ? { y: 0, opacity: 1 } : {}}
               transition={{ duration: 0.7, ease: "easeOut", delay: 0.3 }}
               >
              {result && (
